...
(function()
{
   ...
   Alfresco.doclib.Actions.prototype =
   {
       ...
       */
      onActionTransferir: function dlA_onActionTransferir(asset)
      {
         var me = this;

         Alfresco.util.PopupManager.displayPrompt(
         {
            title: this.msg("message.confirm.transfer.title"),
            text: this.msg("message.confirm.transfer", asset.displayName),
            buttons: [
            {
               text: this.msg("button.transferir"),
               handler: function dlA_onActionTransferir_transfer()
               {
                  this.destroy();
                  me._onActionTransferirConfirm.call(me, asset);
               }
            },
            {
               text: this.msg("button.cancel"),
               handler: function dlA_onActionTransferir_cancel()
               {
                  this.destroy();
               },
               isDefault: true
       ...
       * @param asset {object} Object literal representing the file or folder to be actioned
       */
      onActionFolderTransferir: function dlA_onActionFolderTransferir(asset)
      {
         var me = this;
         ...
         Alfresco.util.PopupManager.displayPrompt(
         {
            ...
            {
               text: this.msg("button.transferir"),
               handler: function dlA_onActionFolderTransferir_transfer()
               {
                  this.destroy();
                  me._onActionFolderTransferirConfirm.call(me, asset);
               }
            },
            {
               text: this.msg("button.cancel"),
               handler: function dlA_onActionFolderTransferir_cancel()
               {
                  this.destroy();
               },
               isDefault: true
      ...
      /**
       * Transfer asset confirmed.
       *
       * @method _onActionDeleteConfirm
       * @param asset {object} Object literal representing the file or folder to be actioned
       * @private
       */
      _onActionTransferirConfirm: function dlA___onActionTransferirConfirm(asset)
      {
          ...
          this.modules.actions.genericAction(
	      {
	         success:
	         {
	            message: this.msg("message.transfer.success", displayName),
	            callback:
                {
	         ...
	         failure:
	         {
	            message: this.msg("message.transfer.failure", displayName)
	         },
	         webscript:
	         {
	        	name: "transferirExpedient?arguments={arguments}", 
           	    method: Alfresco.util.Ajax.POST,
                params:
                {
                	arguments: "<arguments><username>session</username><expID>" + nodeRef.id + "</expID></arguments>"
                }
	         },
	         config:
	         {
       ...
       * @private
       */
      _onActionFolderTransferirConfirm: function dlA___onActionFolderTransferirConfirm(asset)
      {
          var path = asset.location.path,
            fileName = asset.fileName,
            filePath = $combine(path, fileName),
       ...
       * Transfer all asset.
       *
       * @method onActionTranferirTots
       * @param asset {object} Object literal representing the file or folder to be actioned
       */
      onActionTransferirTots: function dlA_onActionTransferirTots(asset)
      {
         var me = this;

         Alfresco.util.PopupManager.displayPrompt(
         {
            title: this.msg("message.confirm.transferAll.title"),
            text: this.msg("message.confirm.transferAll", asset.displayName),
            buttons: [
            {
               text: this.msg("button.transferir"),
               handler: function dlA_onActionTransferir_transfer()
               {
                  this.destroy();
                  me._onActionTransferirTotsConfirm.call(me, asset);
               }
            },
            {
               text: this.msg("button.cancel"),
       ...
       * @param asset {object} Object literal representing the file or folder to be actioned
       */
      onActionFolderTransferirTots: function dlA_onActionFolderTransferirTots(asset)
      {
         var me = this;
         ...
         Alfresco.util.PopupManager.displayPrompt(
         {
            ...
            buttons: [
            {
               ...
               {
                  this.destroy();
                  me._onActionFolderTransferirTotsConfirm.call(me, asset);
               }
            },
            {
               text: this.msg("button.cancel"),
       ...
       * @private
       */
      _onActionTransferirTotsConfirm: function dlA___onActionTransferirTotsConfirm(asset)
      {
          var path = asset.location.path,
            fileName = asset.fileName,
            filePath = $combine(path, fileName),
          ...
          this.modules.actions.genericAction(
	      {
	         success:
	         {
	            message: this.msg("message.transferAll.success", displayName),
	            callback:
                {
	            	fn: function callback_success()
	                {
	         ...
	         failure:
	         {
	            message: this.msg("message.transferAll.failure", displayName)
	         },
	         webscript:
	         {
	        	name: "transferirTotsExpedients?arguments={arguments}", 
           	    method: Alfresco.util.Ajax.POST,
                params:
                {
                	arguments: "<arguments><username>session</username><expID>" + nodeRef.id + "</expID></arguments>"
       ...
       * @private
       */
      _onActionFolderTransferirTotsConfirm: function dlA___onActionFolderTransferirTotsConfirm(asset)
      {
          var path = asset.location.path,
            fileName = asset.fileName,
            filePath = $combine(path, fileName),
       ...
       * Crear etiqueta.
       *
       * @method onActionCrearEtiqueta
       * @param asset {object} Object literal representing the file or folder to be actioned
       */
      onActionCrearEtiqueta: function onActionCrearEtiqueta(asset)
      {
    	  var path = asset.location.path,
          fileName = asset.fileName,
          filePath = $combine(path, fileName),
	      ...
	      this.modules.actions.genericAction(
		  {
		      ...
		      failure:
		      {
		    	  message: this.msg("message.crearEtiqueta.failure", displayName)
		      },
		      
		      webscript:
		      {
		    	  name: "crearEtiquetaExpedient?arguments={arguments}", 
	         	  method: Alfresco.util.Ajax.POST,
	              params:
	              {
	            	  arguments: "<arguments><expID>" + nodeRef.id + "</expID></arguments>"
	              }
		      },
