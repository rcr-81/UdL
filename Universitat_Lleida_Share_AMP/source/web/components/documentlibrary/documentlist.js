      ...
      fnRenderCellThumbnail: function DL_fnRenderCellThumbnail()
      {
         ...
         return function DL_renderCellThumbnail(elCell, oRecord, oColumn, oData)
         {
            ...
            if (scope.options.simpleView)
            {
               ...
               if(Alfresco.DocumentList.contieneTag("arxiu", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/arxiu-32.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("dipòsit", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/diposit-32.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("secció", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/seccio-32.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("ac", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/ac-32.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("ar", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/ar-32.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("pf", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/pf-32.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("pl", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/pl-32.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("columna", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/columna-32.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("prestatge", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/prestatge-32.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("plaça_ac", tags) || Alfresco.DocumentList.contieneTag("plaça_pf", tags)){
            	   if(Alfresco.DocumentList.contieneTag("lliure", tags)){
            		   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/capsaArxiuVerd-32.png" /></a>';
            	   }else if(Alfresco.DocumentList.contieneTag("ocupada", tags) || Alfresco.DocumentList.contieneTag("reservada", tags)){
            		   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/capsaArxiuVermell-32.png" /></a>';
            	   }else{
            		   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/capsaArxiuTaronja-32.png" /></a>';
            	   }
               }else if (Alfresco.DocumentList.contieneTag("calaix", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/calaix-32.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("calaix_arxiu", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/calaixArxiu-32.png" /></a>';
               }else if(Alfresco.DocumentList.contieneTag("plaça_ar", tags)){
            	   if(Alfresco.DocumentList.contieneTag("lliure", tags)){
            		   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/carpetaArxivadorVerd-32.png" /></a>';
            	   }else if(Alfresco.DocumentList.contieneTag("ocupada", tags) || Alfresco.DocumentList.contieneTag("reservada", tags)){
            		   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/carpetaArxivadorVermell-32.png" /></a>';
            	   }else{
            		   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/carpetaArxivadorTaronja-32.png" /></a>';
            	   }
               }else if(Alfresco.DocumentList.contieneTag("plaça_pl", tags)){
            	   if(Alfresco.DocumentList.contieneTag("lliure", tags)){
            		   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/carpetaPlaneraVerd-32.png" /></a>';
            	   }else if(Alfresco.DocumentList.contieneTag("ocupada", tags) || Alfresco.DocumentList.contieneTag("reservada", tags)){
            		   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/carpetaPlaneraVermell-32.png" /></a>';
            	   }else{
               ...
               if(Alfresco.DocumentList.contieneTag("arxiu", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/arxiu-48.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("dipòsit", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/diposit-48.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("secció", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/seccio-48.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("ac", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/ac-48.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("ar", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/ar-48.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("pf", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/pf-48.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("pl", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/pl-48.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("columna", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/columna-48.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("prestatge", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/prestatge-48.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("plaça_ac", tags) || Alfresco.DocumentList.contieneTag("plaça_pf", tags)){
            	   if(Alfresco.DocumentList.contieneTag("lliure", tags)){
            		   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/capsaArxiuVerd-48.png" /></a>';
            	   }else if(Alfresco.DocumentList.contieneTag("ocupada", tags) || Alfresco.DocumentList.contieneTag("reservada", tags)){
            		   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/capsaArxiuVermell-48.png" /></a>';
            	   }else{
            		   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/capsaArxiuTaronja-48.png" /></a>';
            	   }
               }else if (Alfresco.DocumentList.contieneTag("calaix", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/calaix-48.png" /></a>';
               }else if (Alfresco.DocumentList.contieneTag("calaix_arxiu", tags)){
            	   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/calaixArxiu-48.png" /></a>';
               }else if(Alfresco.DocumentList.contieneTag("plaça_ar", tags)){
            	   if(Alfresco.DocumentList.contieneTag("lliure", tags)){
            		   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/carpetaArxivadorVerd-48.png" /></a>';
            	   }else if(Alfresco.DocumentList.contieneTag("ocupada", tags) || Alfresco.DocumentList.contieneTag("reservada", tags)){
            		   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/carpetaArxivadorVermell-48.png" /></a>';
            	   }else{
            		   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/carpetaArxivadorTaronja-48.png" /></a>';
            	   }
               }else if(Alfresco.DocumentList.contieneTag("plaça_pl", tags)){
            	   if(Alfresco.DocumentList.contieneTag("lliure", tags)){
            		   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/carpetaPlaneraVerd-48.png" /></a>';
            	   }else if(Alfresco.DocumentList.contieneTag("ocupada", tags) || Alfresco.DocumentList.contieneTag("reservada", tags)){
            		   elCell.innerHTML = '<span class="folder-small">' + (isLink ? '<span class="link"></span>' : '') + Alfresco.DocumentList.generateFileFolderLinkMarkup(scope, oRecord) + '<img src="' + Alfresco.constants.URL_RESCONTEXT + 'components/documentlibrary/images/carpetaPlaneraVermell-48.png" /></a>';
            	   }else{
