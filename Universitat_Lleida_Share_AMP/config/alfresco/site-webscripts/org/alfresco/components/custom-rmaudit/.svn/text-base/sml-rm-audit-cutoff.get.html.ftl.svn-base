  ...
  <div id="${htmlid}-audit" class="audit">
    <div class="yui-gc">
      <div class="yui-u first">
          <div id="${htmlid}-audit-info" class="audit-info">
             <h2>${msg("label.header.title.transferencia.arxiu")}</h2>
    ...
    <div class="filters">
      <div class="yui-g">
         <div class="yui-g first">
            <div class="yui-u first">
               <div id="${htmlid}-entriesFilter" class="filter">
                  <div class="hd">
                     <label for="${htmlid}-audit-entries" style="text-align:left;">${msg('label.header-entries')}:</label>                     
                  </div>
                  <div class="bd">
                     <input type="text" name="${htmlid}-audit-entries" value="" id="${htmlid}-audit-entries" style="width: 9em; margin-right: 4em;"/>
                  </div>
               </div>
            </div>   
            <div class="yui-u first">
               <div id="${htmlid}-dateFilter" class="filter"> 
                  <div class="hd">
                     <label for="${htmlid}-audit-fromDate" style="text-align:left;">${msg('label.header-from')}:</label>
                  </div>
                  <div class="bd">
                     <input type="text" name="${htmlid}-audit-fromDate" value="" id="${htmlid}-audit-fromDate" style="width: 9em;"/>
                     ...
                     <label for="${htmlid}-audit-toDate" style="text-align:left;">${msg('label.header-to')}:</label><input type="text"  name="${htmlid}-audit-toDate" value="" id="${htmlid}-audit-toDate" style="width: 9em;"/>
         ...
         <div class="yui-g first" style="display:none">
            <div>
