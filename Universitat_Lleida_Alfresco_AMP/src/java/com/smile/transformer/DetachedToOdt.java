...
public class DetachedToOdt extends AbstractContentTransformer2 {

	@Override
	public boolean isTransformable(String sourceMimetype,
			String targetMimetype, TransformationOptions options) {
		if (sourceMimetype.equals("application/dodt")
				&& targetMimetype.equals("application/vnd.sun.xml.writer")) {
			return true;
		} else {
			return false;
		}
